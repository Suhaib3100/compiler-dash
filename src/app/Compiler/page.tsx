...
import { Moon, Sun, Play, Share2, Save, FileCode2, Plus, Trash2, Copy, Edit2, Maximize2, Minimize2, Code2 } from 'lucide-react'
...
export default function PremiumCompiler() {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${theme}`}>
      ...
      <div className={`flex-1 flex ${isFullScreen ? 'flex-col' : ''} h-[calc(100vh-3.5rem)]`}>
        {!isFullScreen && (
